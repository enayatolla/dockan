   ...
   if (theme.iconDesktop && theme.iconMobile) {
      const setThemeInfo = (mode) => {
         ...
         if (theme.iconDesktop)
            theme.iconDesktop.innerHTML = `<use xlink:href="#${
               isDark ? "sun" : "moon"
            }" />`;
   ...
   function initializeSearchComponent(baseId, wrapperId, searchId, resultId) {
      ...
      function hideSearchResults() {
         wrapper.classList.remove(
            "border",
            "bg-white",
            "dark0000:bg-zinc-900",
            "rounded-b-none"
         );
         wrapper.classList.add("bg-gray-100", "dark0000:bg-black");
         search.classList.remove("bg-white", "dark0000:bg-zinc-900");
         search.classList.add("bg-gray-100", "dark0000:bg-black");
      ...
      search.addEventListener("focus", () => {
         ...
         wrapper.classList.remove("bg-gray-100", "dark0000:bg-black");
         search.classList.add("bg-white", "dark0000:bg-zinc-900");
         search.classList.remove("bg-gray-100", "dark0000:bg-black");
